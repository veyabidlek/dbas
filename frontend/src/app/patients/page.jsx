...
export default function Patients() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get(`${apiUrl}/patients/get`);
  ...
  const onCreate = async (data) => {
    try {
      await axios.post(`${apiUrl}/patients/create`, data);
      setMessage("Patient addded successfully!");
      reset();
  ...
  const onDelete = async (data) => {
    try {
      await axios.delete(`${apiUrl}/patients/delete`, { data });
